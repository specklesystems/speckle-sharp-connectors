...
public class GetObjectProperties2 : GH_Component, IGH_VariableParameterComponent
{
  public override Guid ComponentGuid => GetType().GUID;

  protected override Bitmap Icon => Resources.speckle_properties_query;

  public GetObjectProperties2()
    : base(
      "GetObjectPropertyValues2",
      "goP2",
      "Retrieves the values of the properties inside Speckle Objects at the specified keys 2",
