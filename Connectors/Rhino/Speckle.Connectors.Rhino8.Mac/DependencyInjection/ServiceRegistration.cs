...
// macOS head of Speckle.Connectors.RhinoShared/Registration/ServiceRegistration.cs: identical except the DUI view.
public static class ServiceRegistration
{
  public static void AddRhino(this IServiceCollection serviceCollection, bool isConnector)
  {
    if (isConnector)
    {
      ...
      serviceCollection.AddDUIEtoView(); // macOS: Eto/WKWebView host instead of WPF/WebView2
    }
