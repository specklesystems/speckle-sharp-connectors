...
public static class RhinoEvents
{
  ...
  {
    RhinoApp.Idle +=
      (_, e)  => eventAggregator.GetEvent<IdleEvent>().Publish(e);
    ...
    RhinoDoc.SelectObjects +=
      (_, e)  => eventAggregator.GetEvent<SelectObjects>().Publish(e);
    RhinoDoc.DeselectObjects +=
      (_, e)  => eventAggregator.GetEvent<DeselectObjects>().Publish(e);
    RhinoDoc.DeselectAllObjects +=
      (_, e)  => eventAggregator.GetEvent<DeselectAllObjects>().Publish(e);
    RhinoDoc.ActiveDocumentChanged +=
      (_, e)  => eventAggregator.GetEvent<ActiveDocumentChanged>().Publish(e);
    RhinoDoc.DocumentPropertiesChanged +=
      (_, e)  => eventAggregator.GetEvent<DocumentPropertiesChanged>().Publish(e);
    RhinoDoc.AddRhinoObject +=
      (_, e)  => eventAggregator.GetEvent<AddRhinoObject>().Publish(e);
    RhinoDoc.DeleteRhinoObject +=
      (_, e)  => eventAggregator.GetEvent<DeleteRhinoObject>().Publish(e);
    RhinoDoc.RenderMaterialsTableEvent +=
      (_, e)  => eventAggregator.GetEvent<RenderMaterialsTableEvent>().Publish(e);
    RhinoDoc.MaterialTableEvent +=
      (_, e)  => eventAggregator.GetEvent<MaterialTableEvent>().Publish(e);
    RhinoDoc.ModifyObjectAttributes +=
      (_, e)  => eventAggregator.GetEvent<ModifyObjectAttributes>().Publish(e);
    RhinoDoc.ReplaceRhinoObject +=
      (_, e)  => eventAggregator.GetEvent<ReplaceRhinoObject>().Publish(e);
  }
}
