...
/// and <c>MicroStationDocumentModelStore</c>. Each Bentley host application (MicroStation,
/// OpenRoads Designer, OpenBridge Designer, …) supplies its own copy of this static class.
/// </summary>
