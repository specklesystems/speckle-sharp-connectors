  ...
  : ICardSetting
{
  ...
  public string? Title { get; set; } = "Send Volumetric Geometry";
  public string? Description { get; set; } =
    "Extrudes members, walls and slabs into solid meshes from their section and thickness instead of lines and flat surfaces. Elements with unsupported sections keep their wireframe representation.";
