...
public class SendVolumetricGeometrySetting(bool value = SendVolumetricGeometrySetting.DEFAULT_VALUE) : ICardSetting
{
  ...
  public string? Description { get; set; } =
    "Extrudes frames, walls and floors into solid meshes from their section and thickness instead of lines and flat surfaces. Elements with unsupported sections keep their wireframe representation.";
