...
public sealed class LoggingMetricsFactory : IDisposable
{
  ...
  public LoggingCounter<T> CreateCounter<T>(string name, string? unit = null, string? description = null)
    where T : struct =>
    new(_meterSource.CreateCounter<T>(name, unit, description));
...
where T : struct
{
  ...
  public void Add(T value, KeyValuePair<string, object?> tag1, KeyValuePair<string, object?> tag2) => _counter.Add(value, tag1, tag2);
  public void Add(
    T value,
