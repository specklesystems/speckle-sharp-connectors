...
/// <summary>
/// A connector's Speckle 2026.9.0 send builder: converts host objects into a <see cref="BundleBuilder"/> and hands it back
...
/// </summary>
public interface IBundleBuilder<in T>
{
  /// <summary>
...
public sealed record BundleBuild(BundleBuilder Bundle, IReadOnlyList<SendConversionResult> ConversionResults);
