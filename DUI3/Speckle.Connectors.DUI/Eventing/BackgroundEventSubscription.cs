...
/// </summary>
public class BackgroundEventSubscription(IDelegateReference actionReference, IThreadContext threadContext) : EventSubscription(actionReference)
{
  public override void InvokeAction(Action action) => threadContext.RunOnWorker(action);
}
