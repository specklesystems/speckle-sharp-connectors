...
{
  public EventSubscriptionException(string message) : base(message)
  {
  }
  ...
  public EventSubscriptionException(string message, Exception innerException) : base(message, innerException)
  {
  }
}
