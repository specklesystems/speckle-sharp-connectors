...
{
  private sealed class TestDocumentModelStore(IJsonSerializer serializer) : DocumentModelStore(serializer)
  {
  ...
  public void RegisterDependencies_Validation()
  {
    ...
    serviceCollection.AddDUI<TestDocumentModelStore,TestHostObjectBuilder,TestThreadContext>(new("Tests", "test"), "v3");
