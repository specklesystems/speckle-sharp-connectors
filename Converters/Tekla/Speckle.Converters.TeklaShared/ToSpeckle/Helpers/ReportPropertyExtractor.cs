...
{
  private static readonly Dictionary<Type, string[]> s_typeSpecificProperties = new()
  {
    {
      typeof(TSM.Beam),
      new[]
    ...
    },
    {
      ...
      new[] { "VOLUME", "WEIGHT", "AREA", "PROFILE_TYPE", "MATERIAL_TYPE", "CLASS", "PREFIX", "ASSEMBLY_POS", "PHASE" }
    },
